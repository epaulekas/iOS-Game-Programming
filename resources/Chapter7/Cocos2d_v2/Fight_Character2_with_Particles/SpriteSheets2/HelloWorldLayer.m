...
-(id) init
{
	...
	if( (self=[super init]) ) {
        ...
        attackSystem = [CCParticleMeteor node];
        [self addChild:attackSystem z:5 ];
       
        attackSystem.position = ccp (zombie.position.x - 20, zombie.position.y - 50);
        attackSystem.life = .5;
        attackSystem.lifeVar = .8;
        [attackSystem stopSystem];
        attackSystem.scaleX = -1;
        
        /*
        CCParticleSystem* system = [CCParticleMeteor node];
        [self addChild:system z:5 ];
        system.position = ccp (300, 300);
        
        system.startColor =  (ccColor4F){1, 1, 1, 1 };
        system.startColorVar =  (ccColor4F){0, 0, 0, 1 };
        system.endColor =  (ccColor4F){1, 1, 1, 0 };
        system.endColorVar =  (ccColor4F){1, 1, 1, 0 };
        ...
        */
        ...
        CCMoveBy* moveRight = [CCMoveBy actionWithDuration:1.0 position:ccp( 100, 0 ) ];
        ...
        CCMoveBy* moveLeft = [CCMoveBy actionWithDuration:1.0 position:ccp( -100, 0 ) ];
        ...
        CCMoveBy* moveWithPunch = [ CCMoveBy actionWithDuration:.3 position:ccp( 100, 0 )];
        ...
        CCMoveBy* moveWithKick = [ CCMoveBy actionWithDuration:.3 position:ccp( 100, 0 )];
        ...
        CCJumpBy* jumpBy = [ CCJumpBy actionWithDuration:0.5 position:ccp(10,0) height:300 jumps:1];
