...
-(void) addSwipeGestures {
	...
	[[[CCDirector sharedDirector]view]  addGestureRecognizer:swipeUpGR];
	[swipeUpGR release];
	...
	[[[CCDirector sharedDirector]view]  addGestureRecognizer:swipeLeftGR];
	[swipeLeftGR release];
	...
	[[[CCDirector sharedDirector]view]  addGestureRecognizer:swipeRightGR];
...
-(void) addPanGesture {
	...
	[ [[CCDirector sharedDirector]view] addGestureRecognizer:panGR];
	[panGR release];
...
-(void) addPressGesture {
	...
	[ [[CCDirector sharedDirector]view] addGestureRecognizer:longPressGR];
	[longPressGR release];
...
-(void) addPinchGesture {
    ...
    [ [[CCDirector sharedDirector] view] addGestureRecognizer:pinchGR];
	[pinchGR release];
