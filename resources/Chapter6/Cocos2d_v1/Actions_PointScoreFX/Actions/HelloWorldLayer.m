...
-(id) init
{
	...
	if( (self=[super init])) {
        ...
        ccTexParams params = {GL_LINEAR,GL_LINEAR,GL_REPEAT,GL_REPEAT};  //In Cocos2d 2.0 to use GL_REPEAT your image size must be a power of two... ( 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048 )
        ...
        ccTexParams params2 = {GL_LINEAR,GL_LINEAR,GL_REPEAT,GL_REPEAT};  //In Cocos2d 2.0 to use GL_REPEAT your image size must be a power of two... ( 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048 )
