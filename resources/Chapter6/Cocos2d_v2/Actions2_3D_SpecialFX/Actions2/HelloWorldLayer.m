...
-(id) init
{
	...
	if( (self=[super init])) {
        ...
        CCLOG(@"*************************************************** ");
        CCLOG(@"For the 3D effects, be sure to set in AppDelegate... ");
        CCLOG(@"[director_ setProjection:kCCDirectorProjection3D];  ");
        CCLOG(@"*************************************************** ");
...
-(void) specialAction4 {
    ...
    CCLOG(@"Not working as expected on Cocos2d 2.0... bug? ");
